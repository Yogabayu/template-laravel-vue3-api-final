    ...
    methods: {
        ...
        async applyFilter() {
            try {
                ...
                const response = await mainURL.post("/filterData", formData);
        ...
        async getRecaptData(monthYear: any) {
            try {
                ...
                const response = await mainURL.post(`/filterDataReport`, formData, {
                    responseType: 'blob' // tambahkan ini untuk mengunduh file sebagai Blob
                });
        ...
        async getUserAccess() {
            try {
                const response = await mainURL.get("/userAccess");
